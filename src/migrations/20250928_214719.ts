...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "projects_services_provided" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"service" varchar
  ...
  CREATE TABLE "services_key_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"feature" varchar
  ...
  CREATE TABLE "services" (
  	...
  	"estimated_timeline_text" varchar,
  ...
  ALTER TABLE "projects_services_provided" ADD CONSTRAINT "projects_services_provided_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "services_key_features" ADD CONSTRAINT "services_key_features_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."services"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "services_rels" ADD CONSTRAINT "services_rels_technologies_fk" FOREIGN KEY ("technologies_id") REFERENCES "public"."technologies"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "projects_services_provided_order_idx" ON "projects_services_provided" USING btree ("_order");
  CREATE INDEX "projects_services_provided_parent_id_idx" ON "projects_services_provided" USING btree ("_parent_id");
  ...
  CREATE INDEX "services_key_features_order_idx" ON "services_key_features" USING btree ("_order");
  CREATE INDEX "services_key_features_parent_id_idx" ON "services_key_features" USING btree ("_parent_id");
  ...
  CREATE INDEX "services_rels_technologies_id_idx" ON "services_rels" USING btree ("technologies_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "projects_services_provided" CASCADE;
  DROP TABLE "projects" CASCADE;
  DROP TABLE "projects_rels" CASCADE;
  DROP TABLE "services_key_features" CASCADE;
