        ...
        <div className="container bg-accent">
          <div className="max-w-lg m-auto lg:translate-x-32">
            ...
            <h1 className="max-w-[600px] flex-1 text-3xl leading-tight font-semibold tracking-tight text-balance md:text-4xl lg:text-5xl">
              We're Streamline. We're a different kind of planning tool that enables builders to
          ...
          <div className="mt-28 max-w-xl lg:mt-10 lg:translate-x-32">
            <p className="text-lg">
              Tasks have changed, are changing, and will continue to change — for the better. Now is
              the time for productivity to be user-first and internet-first. But in order to do this
          ...
          <div className="mt-6 space-y-6 md:mt-8 md:space-y-8 lg:mt-10 lg:space-y-10">
            ...
            <p className="max-w-xl text-lg lg:translate-x-32">
              Everyone tried fixing the problem by adding features, integrations, and layers of
              complexity. We have spent our careers using, designing, and rethinking tools like
              Trello, Notion, and Asana, encountering this problem firsthand. The existing solutions
              don't work. We believe a to-do app needs to be a dynamic system. But we had to start
              from ground zero.
            </p>
            ...
            <p className="ml-auto max-w-xl text-lg lg:-translate-x-32">
              We started building Streamline in 2019 and launched in 2022. Every single feature has
              been built from scratch — with no unnecessary complexity or outdated tools. We are
              purpose-built to redefine productivity for the next hundred years.
            </p>
            ...
            <div className="ml-auto max-w-xl text-lg lg:-translate-x-32">
              <p>
                We are 100% founder and team-owned, sustainable, and we keep our team small. Over
                time, we'll make this page more polished, but right now we're focused on delivering
                for our users. If you'd
                <br />
