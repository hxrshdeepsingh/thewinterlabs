    ...
    <div className="relative min-h-[calc(100vh-10rem)] flex items-center justify-center px-6 pt-6 overflow-hidden">
      <div className="relative z-[1] text-center max-w-screen-lg">
        ...
        <p className="mt-6 text-[17px] md:text-lg">
          <Highlighter action="highlight" color="#fff4e1">{`At The Winter Labs`}</Highlighter> {`, we turn bold ideas into seamless web solutions. Clean code, thoughtful design, and future-ready technology come together to build products that truly stand out.`}
        </p>
