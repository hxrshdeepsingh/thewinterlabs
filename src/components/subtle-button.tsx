...
export default function BorderButton() {
  ...
  return (
    <div className="w-full flex justify-center items-center bg-gradient-to-br from-black/90 to-black">
      <button
      ...
      >
        ...
        <div
          className="absolute inset-0 rounded-full border-2 border-amber-200/0 
