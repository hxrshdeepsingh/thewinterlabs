...
export default function Cta() {
  return (
    <div className="max-w-custom mx-auto py-20 lg:pt-40 lg:pb-0">
      <div className="container mx-auto">
        <div className="flex flex-col text-center border bg-black rounded-[1rem] p-4 lg:p-14 gap-8 items-center">
          <div>
